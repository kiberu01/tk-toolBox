...
def enter_data():
    ...
    if accepted=="Accepted":
        ...
        if firstname and lastname:
            ...
            print("Nom: ",firstname, "prenom: ",lastname)
            print("title: ",title, "age: ",age, "nationality: ",nationality)
            print("# Courses: ",numcourses, "# Semesters: ",numsemesters)
            print("Registration Status: ",registration_status)
            print("--------------------------------------------------")
            
            filepath = "C:\\Users\\DELL\\OneDrive\\Desktop\\tkinter\\data.xlsx"
...
nationality_combobox=ttk.Combobox(user_info_frame, values=["Africa", "America", "Asia", "Europe"])
